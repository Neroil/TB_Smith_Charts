...
Logiquement, il poursuit des études d'ingénierie électrique et, en 1928, il obtient son diplôme à l'université Tufts, ce qui aboutit à son premier emploi aux laboratoires téléphoniques Bell dans le département de la recherche radio. L'une de ses missions consistait à adapter des antennes aux lignes de transmission, le problème que l'abaque de Smith cherche justement à résoudre.

Dans un premier temps, Smith développe une méthode rapide pour calculer les impédances des lignes de transmission en utilisant un graphique rectangulaire. Cependant, ce graphique rectangulaire présentait rapidement ses limites. Smith, entouré de deux de ses collègues, E.B. Ferrell et J.W. McRae, développe alors une transformation mathématique permettant de projeter les impédances sur un plan circulaire correspondant au coefficient de réflexion#footnote("Note : Explication dans la partie des principes théoriques"), offrant ainsi une représentation beaucoup plus claire et pratique. @smith_history
