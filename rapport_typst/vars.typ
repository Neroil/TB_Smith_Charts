...
#let TBresumePubliable = [
  ...
  \
  \
  Finalement, l'application offre des outils pratiques comme le tuning des composants, l'utilisation d'un catalogue de composants normalisées CEI 60063 créé par l'utilisateur, la prise en compte du facteur de qualité des composants pour des simulations plus réalistes, la gestion de l'historique (undo/redo), et la sauvegarde complète des projets sur lesquels travaille l'utilisateur.
]